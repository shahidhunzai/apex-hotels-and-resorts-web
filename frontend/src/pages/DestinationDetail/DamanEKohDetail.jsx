...
const PindiPointDetail = () => (
  <div className="destination-detail-container">
    <div className="destination-banner" style={{backgroundImage: `url('https://images.unsplash.com/photo-1465101046530-73398c7f28ca?w=1200')`}}>
      <h1 className="destination-banner-title">Daman-e-Koh, Islamabad</h1>
    </div>
    <TouristPointTabs
      infoTitle="A Scenic Viewpoint in Islamabad"
      infoDescription={
        <div className="tp-info-layout" style={{display: 'flex', gap: '24px'}}>
          <div className="tp-info-left">
            <p className="tp-info-desc">
              Daman-e-Koh is a scenic viewpoint offering breathtaking views of the surrounding hills and valleys. It's ideal for families, couples, and solo travelers, featuring fresh mountain air, scenic views, and cozy moments under the stars. This peaceful spot provides the perfect setting to unwind and connect with nature.
            </p>
