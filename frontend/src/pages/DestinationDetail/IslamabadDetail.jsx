        ...
        <div className="tp-info-layout" style={{display: 'flex', gap: '24px'}}>
          <div className="tp-info-left">
            <p className="tp-info-desc">
              Islamabad is a scenic city offering breathtaking views of the surrounding hills and valleys. It's ideal for families, couples, and solo travelers, featuring fresh mountain air, scenic views, and cozy moments under the stars. This peaceful spot provides the perfect setting to unwind and connect with nature.
            </p>
